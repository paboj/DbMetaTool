-- Wygenerowane z manual-test-data/round-2-changes.md.
-- NIE jest to init script — uruchomić ręcznie (isql -i) na już istniejącej bazie,
-- PO wykonaniu backupu bazowego (gbak), żeby backup odzwierciedlał stan sprzed zmian
-- (potrzebny jako "starsza wersja" do testu update-db, scenariusz pkt 4).
